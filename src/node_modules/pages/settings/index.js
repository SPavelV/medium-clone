...
import BackendErrorMessagse from "components/backendErrorMessages";
      ...
      <div className="container page">
        <div className="row">
          <div className="col-md-6 offset-md-3 col-xs-12">
            ...
            {error && <BackendErrorMessagse backendErrors={error.errors} />}
            <form onSubmit={handleSubmit}>
              ...
              <hr />
              <button className="btn btn-outline-danger" onClick={loguout}>
